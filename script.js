    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "KOLBO ELECTRIC משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3a389475-4d2d-4654-bfad-2e05e6f4606c',
                    name: data.name || '',
                    email: data.email || '',
